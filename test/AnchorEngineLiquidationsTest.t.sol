...
contract AnchorEngineLiquidationsTest is AnchorTestFixture {
    ...
    modifier WhenUserCollateralRateFallsBelowBadCollateralRate() {
        ethUsdPriceFeed.updateAnswer(1200e8);
        _;
    }
        ...
        WhenUserCollateralRateFallsBelowBadCollateralRate
    {
        ...
        // Act
        vm.prank(keepers);
        anchorEngine.liquidate(liquidator, user, LIQUIDATION_AMOUNT);
    ...
    function test_UserCanBeSuperLiquidatedWhenCollRatioFallsBelowThreshold()
        public
        WhenUserDepositedCollateralAndMintedAnchorUSD
        WhenLiquidatorHasProvidedLiquidation
        WhenUserCollateralRateFallsBelowBadCollateralRate
    {
        ...
        // Act
        vm.prank(keepers);
        anchorEngine.superLiquidation(liquidator, user, LIQUIDATION_AMOUNT);
        ...
        vars.liquidatedColl = LIQUIDATION_AMOUNT;
        vars.keepersReward =
            (LIQUIDATION_AMOUNT * anchorEngine.keeperRate() * 1e18) /
            vars.userCollRatio;
